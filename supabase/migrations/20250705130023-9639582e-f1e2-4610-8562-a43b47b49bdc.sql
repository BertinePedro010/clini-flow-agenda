...
-- Corrigir a função add_user_to_clinic para funcionar corretamente
...
CREATE POLICY IF NOT EXISTS "Allow profile creation for new users" ON public.users_profiles
  FOR INSERT 
  WITH CHECK (
